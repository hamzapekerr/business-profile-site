import logo from './pobaclogo.jpeg'
...
import logo_dark from './pobaclogo.jpeg'
...
import hamzaImg from './team/hamza.png'
import yusufImg from './team/yusuf.png'
import oguzImg from './team/oguz.png'
import omerImg from './team/omer.png'
import talhaImg from './team/talha.png'

export const teamData = [
  { name: 'Hamza Peker', title: 'Full Stack Development', image: hamzaImg },
  { name: 'Ömer Taha Okur', title: 'Social Media & Digital Marketing', image: omerImg },
  { name: 'Yusuf Biçer', title: 'Backend Developer GİZLİ LİDER', image: yusufImg },
  { name: 'M.Talha Aladağ', title: 'Business Development, Strategy & Marketing', image: talhaImg },
  { name: 'Oğuz Cum', title: 'Mobile Application Development', image: oguzImg },
]