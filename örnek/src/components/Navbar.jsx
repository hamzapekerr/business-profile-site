...
const Navbar = ({ theme, setTheme }) => {
    ...
    return (
        <motion.div
            ...
            className='flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-[var(--color-light-bg)]/80 dark:bg-gray-900/70'
        >
            ...
            >
                ...
                <a onClick={() => setSidebarOpen(false)} href="#" className='sm:hover:border-b'>Anasayfa</a>
                <a onClick={() => setSidebarOpen(false)} href="#services" className='sm:hover:border-b'>Hizmetlerimiz</a>
                <a onClick={() => setSidebarOpen(false)} href="#our-work" className='sm:hover:border-b'>Projelerimiz</a>
                <a onClick={() => setSidebarOpen(false)} href="#contact-us" className='sm:hover:border-b'>İletişim</a>
            </div>
            ...
            <div className='flex items-center gap-2 sm:gap-4'>
                ...
                >
                    Bağlantı <img src={assets.arrow_icon} width={14} alt="" />
                </a>
            </div>
        </motion.div>
    )
